// // - - - src/pages/miscellaneous/step2_uploadSocialMedia.tsx
...
//   handle: z.string().min(1, "A handle or username is required."),
// });
...
//   // Normalize the platform name to lowercase for reliable matching
...
//   // Find the key in the map that is included in the normalized platform name
//   const matchedKey = Object.keys(iconMap).find((key) =>
//     normalizedPlatform.includes(key)
//   );

//   // Return the matched icon, or a default one if no match is found
...
//   // This step is optional, so we mark it as complete immediately.
//   useEffect(() => {
//     onStepComplete(true);
//   }, [onStepComplete]);
