    ...
    <div className="p-4 sm:p-6 lg:p-8 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <Tabs defaultValue="single" className="w-full">
          <TabsList className="h-auto px-1.5 py-1.75 bg-gray-100 shadow shadow-gray-200 rounded-lg w-full grid grid-cols-2">
            {tabs.map((tab) => (
              <TabsTrigger
                key={tab.id}
                value={tab.id}
...
// // --- Bulk Room Form Component (MODIFIED) ---
// function BulkRoomForm({ roomTypes, allAmenities, onSuccess }: any) {
//   const queryClient = useQueryClient();
//   const {
//     control,
...
//   // MODIFICATION: Changed layout to a two-pane grid to include the preview
//   return (
//     <form
//       onSubmit={handleSubmit(onSubmit)}
//       className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start"
...
//         </div>
//       </div>
//       {/* MODIFICATION: Added the new bulk details preview component */}
//       <BulkDetailsPreview
//         control={control}
//         roomTypes={roomTypes}
//         allAmenities={allAmenities}
...
// // --- NEW Bulk Details Preview Component ---
...
//     <Card className="lg:col-span-1 sticky top-8">
//       <CardHeader>
//         <CardTitle>Bulk Creation Summary</CardTitle>
//         <CardDescription>Review the details before submitting.</CardDescription>
//       </CardHeader>
//       <CardContent className="space-y-4">
//         <DetailRow label="Room Type" value={roomTypeName} />
