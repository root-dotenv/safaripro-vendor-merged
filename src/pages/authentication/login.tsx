...
// import { Switch } from "@/components/ui/switch"; // UPDATED: Import Switch instead of Checkbox
...
//   // --- Effects ---
//   // Effect for handling redirection after successful login
//   useEffect(() => {
//     if (isAuthenticated) {
...
//     try {
//       await login(data);
//       // The useEffect above will handle redirection on success
//     } catch (error) {
//       // The auth store already shows a toast error.
...
// // Reusable InputField component (remains unchanged)
