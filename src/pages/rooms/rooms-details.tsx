...
export default function RoomDetailsPage() {
  ...
  const galleryImages = useMemo(() => {
    ...
    // Ensure exactly 3 images: use available images and fill remaining slots with placeholders
  ...
  return (
    <Dialog>
      <div className="min-h-screen bg-[#FFF] p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div className="flex-shrink-0 w-full md:w-auto flex items-center gap-3">
              <div className="text-right flex-grow mr-4">
              ...
              <DialogTrigger asChild>
                <Button className="bg-[#0081FB] hover:bg-blue-600 text-white font-semibold">
                  <TbEdit className="mr-2 h-4 w-4" /> Edit Room
                </Button>
              </DialogTrigger>
              <DropdownMenu>
              ...
              {galleryImages.map((img, index) => (
                ...
                >
                  <img
                    ...
                    className={cn(
                      "rounded-lg object-cover w-full aspect-square transition-all duration-200 border",
                      activeImageIndex === index
                        ? "ring-2 ring-blue-500 ring-offset-2 border-transparent"
                        : "opacity-75 hover:opacity-100 border-gray-200"
                    )}
                  />
                </button>
              ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
              ...
              <div className="space-y-4">
                <div className="flex flex-col md:flex-row justify-between md:items-center gap-2">
                  <div>
                    ...
                    <p className="text-[1rem] text-gray-700">
                      Maximum Guests: {room.max_occupancy}
                    </p>
                  </div>
                  <Badge
                    className={cn(
                      "px-3 py-1 text-sm w-fit",
            ...
            <div className="lg:col-span-2">
              <div className="pt-4 border-t lg:border-none lg:pt-0">
