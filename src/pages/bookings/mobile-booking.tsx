...
// import { GuestDetailsForm } from "./mobile-payment/guest-details";
// import type {
//   BookingConfirmation,
//   GuestDetails,
//   Room,
// } from "./mobile-payment/types";
// import { PaymentForm } from "./mobile-payment/payment";
// import { CheckinGuest } from "./mobile-payment/checkin-guest";
// import {
//   Card,
//   CardHeader,
//   CardTitle,
...
//       service_notes: guestDetails.service_notes || "no,thanks",
...
//           Follow the steps below to complete your mobile booking.
//         </CardDescription>
//       </CardHeader>
...
export default function MobileBooking() {
  ...
  const handleSearchRooms = async () => {
    if (!hotelId) {
      setError("Authentication error: Hotel ID is missing.");
      return;
    }
    if (!startDate || !endDate) {
      setError("Please select both start and end dates");
    ...
    try {
      const url = `${SEARCH_API_URL}rooms/availability/range/?hotel_id=${hotelId!}&start_date=${startDate}&end_date=${endDate}`;
      const response = await fetch(url);
