...
//         <CardHeader className="bg-none border-b border-gray-200 shadow-gray-100 shadow">
                    ...
                    >
                      ...
                      <TableCell className="px-6 py-4 whitespace-nowrap text-right">
                        <Button
                          onClick={() => onSelectRoom(room)}
                          disabled={!isRoomFullyAvailable(room)}
                          className="bg-green-600 hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white text-sm font-semibold rounded"
                        >
                          Select & Book
                        </Button>
                      </TableCell>
