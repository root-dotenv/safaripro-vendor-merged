// - - - src/pages/bookings/mobile-payment/guest-details.tsx
...
export const GuestDetailsForm: React.FC<GuestDetailsFormProps> = ({
  ...
  // --- BILLING VIEW (with new charge breakdown logic) ---
  if (step === "billing" && bookingConfirmation) {
    ...
    return (
      <Card className="border-gray-200 max-w-[640px] w-full shadow-lg rounded-xl">
        <CardHeader className="border-b">
          ...
          <CardDescription>
            ...
            created. Please review the final charges.
          </CardDescription>
        </CardHeader>
  ...
  return (
    <Card className="border-gray-200 shadow-lg rounded-xl max-w-[700px] w-full">
      <CardHeader className="border-b">
        <CardTitle className="text-xl font-semibold text-gray-800 flex items-center">
          ...
          <div className="space-y-4 pt-6 border-t">
            <div>
              ...
              <Textarea
                ...
                className="mt-2"
                placeholder="e.g., Delivery man coming at 8AM..."
              />
            </div>
