...
//   ChevronsUpDown,
//   Globe,
//   Building2, // --- NEW: Icon for authority ---
// } from "lucide-react";
...
// // --- MODIFIED: Import countries AND issuing authorities from the centralized file ---
// import { countries, issuingAuthorities } from "@/api/local";

// const API_BASE_URL = import.meta.env.VITE_VENDOR_BASE_URL;

// // ... (CountrySelector component remains unchanged)
...
//   );
// };
// // --- NEW: Reusable component for selecting an issuing authority ---
...
//   // --- MODIFIED: State to handle the authority selector and custom input ---
...
//     // --- MODIFIED: Determine the final value for "issued_by" ---
//     const finalIssuedBy =
...
//     }
//     // --- MODIFIED: Use the final determined value ---
...
//         {/* ... other form fields (number, issueDate, expiryDate, issuePlace) remain the same ... */}
//         <FormField
...
//           />
//         </FormField>
//         {/* --- MODIFIED: Replaced text input with the new AuthoritySelector and conditional input --- */}
...
//         </div>
//       </div>
//       {/* ... other form fields (description, file upload, etc.) remain the same ... */}
//       <FormField
...
// // ... (Step2_UploadDocument component remains unchanged)
...
//   return (
//     <div>
//       {/* --- NEW: Success message for the user --- */}
//       <Alert
//         variant="default"
//         className="bg-[#FFF] mb-4 py-4 border-[1.25px] rounded-[6px] shadow border-[#DADCE0] text-green-800"
//       >
//         <FaCheck className="h-5 w-5 !text-teal-600" />
//         <AlertTitle className="font-bold inter text-lg">
//           Company Profile Created!
//         </AlertTitle>
//         <AlertDescription className="font-medium inter text-teal-900">
//           Congratulations, you're making great progress! Please upload the
//           required documents below to complete your registration.
//         </AlertDescription>
//       </Alert>
