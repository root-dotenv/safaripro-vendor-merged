// // src/pages/miscellaneous/Step4_ReviewHotel_ManualSave.tsx
...
//       <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 bg-none">
//         <div className="p-6 border rounded-lg bg-[#FFF] border-[#DADCE0] space-y-4">
//           <InputGroup label="Hotel Name" error={errors.name?.message}>
//             <Input {...register("name")} />
//           </InputGroup>
//           <InputGroup label="Description" error={errors.description?.message}>
//             <Textarea {...register("description")} rows={6} />
//           </InputGroup>
//           <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
//             <InputGroup label="Check-in" error={errors.check_in_from?.message}>
//               <Input type="time" {...register("check_in_from")} />
//             </InputGroup>
//             <InputGroup label="Check-out" error={errors.check_out_to?.message}>
//               <Input type="time" {...register("check_out_to")} />
//             </InputGroup>
//             <InputGroup label="Rating" error={errors.star_rating?.message}>
//               <Controller
//                 name="star_rating"
//                 control={control}
//                 render={({ field }) => (
...
//             <InputGroup label="Latitude" error={errors.latitude?.message}>
//               <Input
//                 type="number"
//                 step="any"
...
//               />
//             </InputGroup>
//             <InputGroup label="Longitude" error={errors.longitude?.message}>
//               <Input
//                 type="number"
//                 step="any"
